...
class Heuristics_H8:
    ...
    def heuristic_8(node, my_symbol, opponent):
        ...
        #Estoy 100% seguro de que la 'pq_2h' siempre tendrá algún nodo que sacar ya que al principio entra de cajón el primerito que saca la 'pq_h'
        aux = pq_2h.get()
...
class World_H8:
    ...
    def bot(self, board, heuristic):
        ...
        #Estoy 100% seguro de que la 'pq_2' siempre tendrá algún nodo que sacar ya que al principio entra de cajón el primerito que saca la 'pq'
        my_move = pq_2.get()
        #H8
